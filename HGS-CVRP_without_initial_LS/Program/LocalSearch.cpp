...
// relocate move ~ remove u from route u and place it after v in route v (can be the same route but can be different too)
...
// relocate move ~ remove u and u->next from route u and place them after v in route v (can be the same route but can be different too)
...
// relocate move ~ remove u and u->next from route u and place them in reverse order after v in route v (can be the same route but can be different too)
...
// swap move ~ swap u and v in route u and route v (can be the same but can be different too)
...
// swap move ~ remove u and u->next from route u and swap it with v from route v (can be the same route but can be different too)
...
// swap move ~ swap u and u->next from route u with v and v->next from route v (can be the same route but can be different too)
